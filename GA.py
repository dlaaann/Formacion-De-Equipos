...
class GA_:
    ...
    def Construir_Poblacion_Inicial(self, n):
        Poblacion = []
        for i in range(n):
    ...
    def GA_esquema(self):
        ...
        n = 100
        Poblacion = self.Construir_Poblacion_Inicial(n)
        while True:
            ...
            Poblacion = self.Reemplazo(n, Poblacion, Descendientes)
